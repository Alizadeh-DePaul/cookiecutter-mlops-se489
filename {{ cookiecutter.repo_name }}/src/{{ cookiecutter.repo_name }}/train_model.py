...
from {{ cookiecutter.repo_name }}.config import DEFAULT_CONFIG, MODELS_DIR, PROCESSED_DATA_DIR
from {{ cookiecutter.repo_name }}.logging_config import get_logger, setup_logging
