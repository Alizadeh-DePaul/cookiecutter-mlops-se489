...
- [ ] **Scope & Objectives**: Define the problem statement, goals, and success metrics for {{ cookiecutter.project_name }}
...
- [ ] **Team Roles**: Clearly define responsibilities (author: {{ cookiecutter.author_name }}, team members, reviewers)
